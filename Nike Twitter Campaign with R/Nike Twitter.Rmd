...
user_id: Twitter US id

user_created_at: Time of Twitter Account creation

user_name: STR user name

user_screen_name: STR screen name

user_description: STR description user

tweet_created_at: Time of tweet

tweet_display_text_range: STR length

tweet_full_text: STR of tweet

tweet_favorite_count: Numbers of users who favorite the tweet

tweet_is_quote_status: =1 if tweet quoted

tweet_possibly_sensitive: =1 if sensitive tweet

tweet_retweet_count: number of retweets

user_default_profile: =1 if True

user_default_profile_image: =1 if True

user_favourites_count: Number of times user favorites

user_follow_request_sent: =1 if user request sent

user_followers_count: Number of followers

user_friends_count: Number of friends

user_geo_enabled: =1 if True

user_has_extended_profile: =1 if True

user_is_translation_enabled: =1 if True

user_lang: =1 if language is English

user_listed_count: Number of listed

user_profile_use_background_image: =1 if true

user_statuses_count: Number of statuses

user_translator_type: =1 if True

user_verified: =1 if user verified
